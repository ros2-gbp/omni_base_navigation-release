## omni_base_navigation (humble) - 2.22.1-1

The packages in the `omni_base_navigation` repository were released into the `humble` distro by running `/usr/bin/bloom-release --track humble --rosdistro humble -y omni_base_navigation` on `Tue, 23 Jun 2026 10:08:04 -0000`
